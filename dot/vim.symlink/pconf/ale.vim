...
"             for lang in langs
"                 execute 'autocmd FileType ' . lang . ' nnoremap <silent> <leader>gd :ALEGoToDefinition<CR>'
"                 execute 'autocmd FileType ' . lang . ' nnoremap <silent> <leader>r :ALEFindReferences<CR>'
"                 execute 'autocmd FileType ' . lang . ' nnoremap <silent> K :ALEHover<CR>'
"             endfor
"         endfor
"     endfor
" augroup end
